...
namespace cpstl {
    ...
    public:
         ...
         */
        inline void update(T const &value, int at)
        {
         ...
         */
        inline T sum(int begin, int end)
        {
         ...
         */
        inline int max(T const value)
        {
            assert(false && "Not implemented yet");
        }

        inline std::vector<T> get_stucture()
        {
            return structure;
        }
